...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="bg-gray-900 px-4 md:px-8 py-4 flex items-center justify-between text-white">
      <div className="flex items-center space-x-4">
        ...
        <div className="font-bold text-xl tracking-wide">Fake Store.pk</div>
      </div>
      <ul
        className={`${
          isMenuOpen
